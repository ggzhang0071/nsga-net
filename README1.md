...
``` shell
python test.py --net_type macro --model_path weights.pt
```
...
``` shell
python test.py --net_type micro --arch NSGANet --init_channels 26 --filter_increment 4 --SE --auxiliary --model_path weights.pt
```
...
``` shell
python test.py --net_type micro --arch NSGANet --init_channels 34 --filter_increment 4 --auxiliary --model_path weights.pt
```
